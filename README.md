# CUG19 Tutorial: Deep Learning At Scale

This repository contains the material for the CUG19 tutorial:
...
**Contents**
* [Links](https://github.com/NERSC/cug19-da-tutorial#links)
* [Installation](https://github.com/NERSC/cug19-da-tutorial#installation)
* [Navigating the repository](https://github.com/NERSC/cug19-da-tutorial#navigating-the-repository)
* [Hands-on walk-through](https://github.com/NERSC/cug19-da-tutorial#hands-on-walk-through)
    * [Single node training example](https://github.com/NERSC/cug19-da-tutorial#single-node-training-example)
    * [Multi-node training example](https://github.com/NERSC/cug19-da-tutorial#multi-node-training-example)
    * [Advanced example: multi-node ResNet50 on ImageNet-100](https://github.com/NERSC/cug19-da-tutorial#advanced-example-multi-node-resnet50-on-imagenet-100)
* [Code references](https://github.com/NERSC/cug19-da-tutorial#code-references)
...
2. Clone the repository using git:\
   `git clone https://github.com/NERSC/cug19-da-tutorial.git`
